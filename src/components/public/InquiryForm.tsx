...
export function InquiryForm({ defaultPlayerId }: { defaultPlayerId?: string | undefined }) {
  ...
  function submit(e: React.FormEvent) {
    ...
    actions.logActivity(
      `Nueva solicitud de información de ${form.name}${form.organization ? ` (${form.organization})` : ""}`,
      "contacto",
    );
    toast.success("Solicitud enviada", {
      description: "El equipo de la agencia la verá en el panel de gestión.",
    });
    setForm({
      name: "",
      organization: "",
    ...
    <form onSubmit={submit} className="grid gap-4 sm:grid-cols-2">
      ...
      <div className="grid gap-2">
        ...
        <Input
          ...
          value={form.role}
          onChange={set("role")}
          placeholder="Director deportivo, scout…"
        />
      </div>
      <div className="grid gap-2">
